CREATE DATABASE sor_Constructora;
USE sor_Constructora;
...
INSERT INTO CostosProyecto (proyecto_id, logistica, mano_obra, equipos, total) VALUES
  ...
  (7, 17000.00, 27000.00, 11000.00, 55000.00),
  (8, 21000.00, 31000.00, 17000.00, 69000.00),
  (9, 24000.00, 34000.00, 19000.00, 77000.00),
  (10, 23000.00, 33000.00, 16000.00, 72000.00),
  (11, 19000.00, 29000.00, 12000.00, 60000.00),
  (12, 23000.00, 33000.00, 17000.00, 73000.00),
  (13, 25000.00, 35000.00, 19000.00, 79000.00),
  (14, 21000.00, 31000.00, 15000.00, 67000.00),
  (15, 18000.00, 28000.00, 13000.00, 59000.00),
  (16, 22000.00, 32000.00, 18000.00, 72000.00),
  (17, 20000.00, 30000.00, 14000.00, 64000.00),
  (18, 24000.00, 34000.00, 16000.00, 74000.00),
  (19, 27000.00, 37000.00, 21000.00, 85000.00),
  (20, 26000.00, 36000.00, 20000.00, 82000.00),
  (21, 17000.00, 27000.00, 11000.00, 55000.00),
  (22, 20000.00, 30000.00, 15000.00, 65000.00),
  (23, 23000.00, 33000.00, 17000.00, 73000.00),
  (24, 25000.00, 35000.00, 19000.00, 79000.00),
  (25, 21000.00, 31000.00, 15000.00, 67000.00),
  (26, 18000.00, 28000.00, 13000.00, 59000.00),
  (27, 22000.00, 32000.00, 18000.00, 72000.00),
  (28, 20000.00, 30000.00, 14000.00, 64000.00),
  (29, 24000.00, 34000.00, 16000.00, 74000.00),
  (30, 27000.00, 37000.00, 21000.00, 85000.00),
  (31, 21000.00, 31000.00, 15000.00, 67000.00),
  (32, 19000.00, 29000.00, 12000.00, 60000.00),
  (33, 23000.00, 33000.00, 17000.00, 73000.00),
  (34, 25000.00, 35000.00, 19000.00, 79000.00),
  (35, 18000.00, 28000.00, 13000.00, 59000.00),
  (36, 22000.00, 32000.00, 18000.00, 72000.00),
  (37, 20000.00, 30000.00, 14000.00, 64000.00),
  (38, 24000.00, 34000.00, 16000.00, 74000.00),
  (39, 27000.00, 37000.00, 21000.00, 85000.00),
  (40, 21000.00, 31000.00, 15000.00, 67000.00),
  (41, 18000.00, 28000.00, 13000.00, 59000.00),
  (42, 22000.00, 32000.00, 18000.00, 72000.00),
  (43, 20000.00, 30000.00, 14000.00, 64000.00),
  (44, 24000.00, 34000.00, 16000.00, 74000.00),
  (45, 27000.00, 37000.00, 21000.00, 85000.00),
  (46, 21000.00, 31000.00, 15000.00, 67000.00),
  (47, 19000.00, 29000.00, 12000.00, 60000.00),
  (48, 23000.00, 33000.00, 17000.00, 73000.00),
  (49, 25000.00, 35000.00, 19000.00, 79000.00),
  (50, 18000.00, 28000.00, 13000.00, 59000.00);
...
INSERT INTO SeguimientoProyecto (proyecto_id, fecha_inicio, fecha_finalizacion, plazo_estimado, plazo_real, estado, problemas, acciones_correctivas) VALUES
  ...
  (7, '2023-07-01', '2023-09-15', 75, 77, 'En progreso', 'Reasignación de personal', 'Aceleración en los trabajos'),
  (8, '2023-08-01', '2023-11-30', 120, 115, 'Concluido', 'Ninguno', 'N/A'),
(9, '2023-09-15', '2023-12-31', 105, 108, 'En progreso', 'Retraso en la entrega de materiales', 'Ajuste en la programación'),
  (10, '2023-10-01', '2024-01-31', 120, 125, 'En progreso', 'Problemas con la licencia de construcción', 'Negociación con autoridades municipales'),
  (11, '2023-11-01', '2024-02-29', 120, 118, 'En progreso', 'Retraso en la entrega de materiales', 'Reasignación de recursos'),
  (12, '2023-12-01', '2024-05-31', 180, 175, 'En progreso', 'Cambios en el diseño', 'Ajuste en los planos'),
  (13, '2024-01-01', '2024-07-31', 210, 205, 'En progreso', 'Problemas con proveedores', 'Búsqueda de alternativas'),
  (14, '2024-02-01', '2024-05-15', 105, 100, 'Concluido', 'Ninguno', 'N/A'),
  (15, '2024-03-01', '2024-09-30', 210, 215, 'En progreso', 'Retraso en la obtención de permisos', 'Negociación con autoridades'),
  (16, '2024-04-01', '2024-08-31', 150, 145, 'Concluido', 'Ninguno', 'N/A'),
  (17, '2024-05-01', '2024-07-15', 75, 78, 'En progreso', 'Problemas con subcontratistas', 'Supervisión más estricta'),
  (18, '2024-06-01', '2024-09-30', 120, 115, 'Concluido', 'Ninguno', 'N/A'),
  (19, '2024-07-01', '2024-12-31', 180, 185, 'En progreso', 'Variaciones en los costos de materiales', 'Reevaluación del presupuesto'),
  (20, '2024-08-01', '2024-11-30', 120, 115, 'Concluido', 'Ninguno', 'N/A'),
(21, '2024-09-01', '2024-12-15', 105, 102, 'En progreso', 'Reasignación de personal', 'Aceleración en los trabajos'),
  (22, '2024-10-01', '2025-01-31', 120, 115, 'Concluido', 'Ninguno', 'N/A'),
  (23, '2024-11-01', '2025-04-30', 180, 175, 'En progreso', 'Cambios en el diseño', 'Ajuste en los planos'),
  (24, '2024-12-01', '2025-05-31', 180, 185, 'En progreso', 'Variaciones en los costos de materiales', 'Reevaluación del presupuesto'),
  (25, '2025-01-01', '2025-06-30', 180, 183, 'En progreso', 'Retraso en la obtención de permisos', 'Negociación con autoridades'),
(26, '2025-02-01', '2025-07-31', 180, 178, 'En progreso', 'Retraso en la entrega de materiales', 'Reasignación de recursos'),
  (27, '2025-03-01', '2025-08-31', 180, 182, 'En progreso', 'Problemas con proveedores', 'Búsqueda de alternativas'),
  (28, '2025-04-01', '2025-09-30', 180, 185, 'En progreso', 'Variaciones en los costos de materiales', 'Reevaluación del presupuesto'),
  (29, '2025-05-01', '2025-10-31', 180, 183, 'En progreso', 'Retraso en la obtención de permisos', 'Negociación con autoridades'),
  (30, '2025-06-01', '2025-11-30', 180, 178, 'En progreso', 'Cambios en el diseño', 'Ajuste en los planos'),
  (31, '2025-07-01', '2025-12-31', 180, 180, 'En progreso', 'Reasignación de personal', 'Aceleración en los trabajos'),
  (32, '2025-08-01', '2026-01-31', 180, 183, 'En progreso', 'Cambios en el diseño', 'Ajuste en los planos'),
  (33, '2025-09-01', '2026-02-28', 180, 175, 'En progreso', 'Problemas con subcontratistas', 'Supervisión más estricta'),
  (34, '2025-10-01', '2026-03-31', 180, 178, 'En progreso', 'Retraso en la entrega de materiales', 'Reasignación de recursos'),
  (35, '2025-11-01', '2026-04-30', 180, 182, 'En progreso', 'Problemas con proveedores', 'Búsqueda de alternativas'),
  (36, '2026-01-01', '2026-06-30', 180, 178, 'En progreso', 'Retraso en la entrega de materiales', 'Reasignación de recursos'),
  (37, '2026-02-01', '2026-07-31', 180, 182, 'En progreso', 'Cambios en el diseño', 'Ajuste en los planos'),
  (38, '2026-03-01', '2026-08-31', 180, 185, 'En progreso', 'Variaciones en los costos de materiales', 'Reevaluación del presupuesto'),
  (39, '2026-04-01', '2026-09-30', 180, 183, 'En progreso', 'Retraso en la obtención de permisos', 'Negociación con autoridades'),
  (40, '2026-05-01', '2026-10-31', 180, 178, 'En progreso', 'Problemas con subcontratistas', 'Supervisión más estricta'),
  (41, '2026-06-01', '2026-11-30', 180, 175, 'En progreso', 'Problemas con proveedores', 'Búsqueda de alternativas'),
  (42, '2026-07-01', '2026-12-31', 180, 180, 'En progreso', 'Retraso en la entrega de materiales', 'Reasignación de recursos'),
  (43, '2026-08-01', '2027-01-31', 180, 182, 'En progreso', 'Cambios en el diseño', 'Ajuste en los planos'),
  (44, '2026-09-01', '2027-02-28', 180, 178, 'En progreso', 'Problemas con subcontratistas', 'Supervisión más estricta'),
  (45, '2026-10-01', '2027-03-31', 180, 183, 'En progreso', 'Retraso en la obtención de permisos', 'Negociación con autoridades'),
(46, '2027-04-01', '2027-09-30', 180, 175, 'En progreso', 'Problemas con proveedores', 'Búsqueda de alternativas'),
  (47, '2027-05-01', '2027-10-31', 180, 178, 'En progreso', 'Retraso en la entrega de materiales', 'Reasignación de recursos'),
  (48, '2027-06-01', '2027-11-30', 180, 182, 'En progreso', 'Cambios en el diseño', 'Ajuste en los planos'),
  (49, '2027-07-01', '2027-12-31', 180, 180, 'En progreso', 'Retraso en la obtención de permisos', 'Negociación con autoridades'),
  (50, '2027-08-01', '2028-01-31', 180, 185, 'En progreso', 'Variaciones en los costos de materiales', 'Reevaluación del presupuesto');
